...
count = len(os.listdir("AtoZ_3.1/A"))
...
while True:
    try:
        ...
        if interrupt & 0xFF == ord('n'):
            ...
            count = len(os.listdir("AtoZ_3.1/" + p_dir )) 
        ...
        if flag==True:
            ...
            if suv==50:
                flag=False
            if step%2==0:
                cv2.imwrite("AtoZ_3.1/" + p_dir + "/" + c_dir + str(count) + ".jpg", img_final1)
                cv2.imwrite("AtoZ_3.1/" + p_dir + "/" + c_dir + str(count) + "_drawn.jpg", img_final2)
