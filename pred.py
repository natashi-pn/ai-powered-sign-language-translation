...
class Application:
    ...
    def __init__(self):
        ...
        self.root = tk.Tk()
        self.root.title("Sign Language Translation System")
        ...
        self.T = tk.Label(main_frame, text="Sign Language Translation System", 
                        font=("Inter", 28, "bold"), fg="#dfe9eb", bg="#1e1e1e")
        self.T.pack(pady=(0, 20))

       
        video_frame = tk.Frame(main_frame, bg="#222222")
        video_frame.pack(fill='both', expand=True, pady=(0, 20)) 


        self.panel = tk.Label(video_frame, bg="#222222", fg='white', 
                            text="Camera Feed Loading...", font=("Inter", 12))
        self.panel.grid(row=0, column=0, padx=(0, 10), sticky="nsew")  

        self.panel2 = tk.Label(video_frame, bg='#222222', fg='white',
                            text="Hand Visualization", font=("Inter", 12))
        self.panel2.grid(row=0, column=1, padx=(10, 0), sticky="nsew")


        video_frame.columnconfigure(0, weight=1, uniform="equal") 
        video_frame.columnconfigure(1, weight=1, uniform="equal")  
        video_frame.rowconfigure(0, weight=1)

    
        self.panel.config(anchor="center") 
        self.panel2.config(anchor="center") 

        text_frame = tk.Frame(main_frame, bg="#222222")
        text_frame.pack(fill='x', pady=(0, 20))

        char_frame = tk.Frame(text_frame, bg='#222222')
        char_frame.pack(fill='x', pady=(0, 10))

        self.T1 = tk.Label(char_frame, text="Detected Character:", 
                        font=("Inter", 16, "bold"), bg='#222222', fg='#d0deed')
        self.T1.pack(side='left')

        self.panel3 = tk.Label(char_frame, text="None", font=("Inter", 16), 
                            bg='#222222', fg='#d0deed')
        self.panel3.pack(side='left', padx=(10, 0))

        sentence_frame = tk.Frame(text_frame, bg='#222222')
        sentence_frame.pack(fill='x', pady=(0, 10))

        self.T3 = tk.Label(sentence_frame, text="Current Sentence:", 
                        font=("Inter", 16, "bold"), bg='#222222', fg='#d0deed')
        self.T3.pack(side='left')

        self.panel5 = tk.Label(sentence_frame, text=" ", font=("Inter", 16), 
                            bg='#222222', fg='#d0deed', wraplength=1000)
        self.panel5.pack(side='left', padx=(10, 0))

        suggestions_frame = tk.Frame(main_frame, bg='#1e1e1e')
        suggestions_frame.pack(fill='x', pady=(0, 20))

        self.T4 = tk.Label(suggestions_frame, text="Word Suggestions:", 
                        font=("Inter", 16, "bold"), bg='#1e1e1e', fg='#d0deed')
        self.T4.pack(anchor='w', pady=(0, 10))

        self.b1=tk.Button(self.root)
        self.b1.place(x=390,y=738)
        self.b1.config(text=" ", font=("Arial", 10))
        
        self.b2 = tk.Button(self.root)
        self.b2.place(x=590, y=738)
        self.b2.config(text=" ", font=("Arial", 10))
        
        self.b3 = tk.Button(self.root)
        self.b3.place(x=790, y=738)
        self.b3.config(text=" ", font=("Arial", 10))
    
        self.b4 = tk.Button(self.root)
        self.b4.place(x=990, y=738)
        self.b4.config(text=" ", font=("Arial", 10))
        
    
        self.speak = tk.Button(self.root)
        self.speak.place(x=1305, y=738)
        self.speak.config(text="Speak Text", font=("Arial", 15), wraplength=100, command=self.speak_fun)

        self.clear = tk.Button(self.root)
        self.clear.place(x=1205, y=738)
        self.clear.config(text="Clear Text", font=("Arial", 15), wraplength=100, command=self.clear_fun)
    ...
    def predict(self, test_image):
        ...
        white = white.reshape(1, 400, 400, 1) / 255.0
